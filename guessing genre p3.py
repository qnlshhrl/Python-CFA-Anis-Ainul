...
#Output
        if x == guess:
           print("You guessed{}. Congratulations you're the smartest! Oh yeahhh".format(guess))
           break
        else:
           print("You guessed {}. Unfortunately you got it wrong booo. you're noob. Please try again!".format(guess))
